...
export const unwrapMeasurableEl = ($el: Measurable | null | ComponentPublicInstance) => {
...
function deriveExtraModifiers(options: any, modifiers: UsePopperCoreConfigProps['popperOptions']['modifiers']) {
  if (modifiers) {
