<template>
  ...
  import { useZIndex, useNamespace } from '../../../hooks';
  ...
  const { create } = createComponent('PopperContent');
  
  export default create({
    props: usePopperContentProps,
    emits: ['mouseenter', 'mouseleave'],
    setup(props) {
      const { triggerRef, popperInstanceRef, contentRef } = inject(POPPER_INJECTION_KEY, undefined)!;
