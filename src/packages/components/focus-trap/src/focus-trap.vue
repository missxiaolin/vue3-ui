...
<script lang="ts">
import { ref, onMounted, onBeforeUnmount, provide, unref, watch } from 'vue';
import { on, off } from '../../../utils/dom';
import { EVENT_CODE } from '../../../utils/aria';
import { focusableStack, focusFirstDescendant, getEdges, tryFocus, obtainAllFocusableElements } from './utils';
import {
...
const { create } = createComponent('FocusTrap');
export default create({
  ...
  setup(props, { emit }) {
    ...
    const onFocusOut = (e: Event) => {
      ...
      if (!trapContainer.contains((e as FocusEvent).relatedTarget as HTMLElement | null)) {
        tryFocus(lastFocusAfterMounted, true);
      }
    };
