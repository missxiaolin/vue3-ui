...
import { composeEventHandlers, on, off } from '../../../utils/dom';
import { rovingFocusGroupProps, ROVING_FOCUS_COLLECTION_INJECTION_KEY } from './roving-focus-group';
...
const { create } = createComponent('RovingFocusGroupImpl');
export default create({
  inheritAttrs: false,
  props: rovingFocusGroupProps,
  emits: [CURRENT_TAB_ID_CHANGE_EVT, 'entryFocus'],
  setup(props, { emit }) {
    const currentTabbedId = ref<string | null>((props.currentTabId || props.defaultCurrentTabId) ?? null);
