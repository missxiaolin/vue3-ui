...
<script lang="ts">
import { computed, defineComponent, inject, ref, unref, nextTick, provide } from 'vue';
...
const { componentName, create } = createComponent('RovingFocusItem');
export default create({
  components: {
    RovingFocusCollectionItem
  },
  props: {
    focusable: {
      type: Boolean,
