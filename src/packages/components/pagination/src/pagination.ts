...
export default create({
  ...
  setup(props, { emit, slots }) {
    ...
    const hasPageSizeListener =
      'onUpdate:pageSize' in vnodeProps || 'onUpdate:page-size' in vnodeProps || 'onSizeChange' in vnodeProps;
      ...
      if (props.layout.includes('sizes')) {
        if (!isAbsent(props.pageCount)) {
          ...
          if (!isAbsent(props.pageSize)) {
            ...
            // else page size is controlled by e-pagination internally
          }
        }
      }
      return true;
    ...
    return () => {
      ...
      const rightWrapperRoot = h('div', { class: 'l-pagination__rightwrapper' }, rightWrapperChildren);
        ...
        'div',
        {
          ...
          class: [
            'l-pagination',
            {
              ...
              'l-pagination--small': props.small
            }
          ]
        },
        rootChildren
