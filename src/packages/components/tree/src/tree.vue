<template>
  ...
  >
    ...
    <div v-if="isEmpty" :class="ns.e('empty-block')">
      <span :class="ns.e('empty-text')">{{ emptyText ?? '空文字' }}</span>
      <!-- emptyText ?? t('el.tree.emptyText') -->
    </div>
    <div v-show="dragState.showDropIndicator" ref="dropIndicator$" :class="ns.e('drop-indicator')"></div>
  </div>
</template>
<script lang="ts">
import { toRefs, computed, defineComponent, getCurrentInstance, provide, ref, watch } from 'vue';
import { useNamespace, useLocale } from '../../../hooks';
import createComponent from '../../../utils/create';
const { create, componentName } = createComponent('Tree');

import TreeStore from './model/tree-store';
import { getNodeKey as getNodeKeyUtil } from './model/util';
import LTreeNode from './tree-node.vue';
