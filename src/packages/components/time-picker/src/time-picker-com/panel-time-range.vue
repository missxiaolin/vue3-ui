<template>
  <div v-if="actualVisible || visible" class="l-time-range-picker l-picker-panel">
    <div class="l-time-range-picker__content">
      <div class="l-time-range-picker__cell">
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
          class="l-time-range-picker__body l-time-panel__content"
        >
          <time-spinner
            ref="minSpinner"
            role="start"
      ...
      <slot name="time-range-separator">
        <span class="l-time-range-picker__separator">{{ t('el.datepicker.rangeSeparator') }}</span>
      </slot>
      <div class="l-time-range-picker__cell">
        <div
          :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
    ...
    <div class="l-time-panel__footer">
      <button type="button" class="l-time-panel__btn cancel" @click="handleCancel()">{{
        t('el.datepicker.cancel')
      }}</button>
      <button type="button" class="l-time-panel__btn confirm" :disabled="btnConfirmDisabled" @click="handleConfirm()">{{
