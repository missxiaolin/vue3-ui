<template>
  <transition :name="transitionName">
    <div v-if="actualVisible || visible" class="l-time-panel">
      <div class="l-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
      ...
      <div class="l-time-panel__footer">
        ...
        <button type="button" class="l-time-panel__btn confirm" @click="handleConfirm()">
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const transitionName = computed(() => {
      return props.actualVisible === undefined ? 'l-zoom-in-top' : '';
    });
