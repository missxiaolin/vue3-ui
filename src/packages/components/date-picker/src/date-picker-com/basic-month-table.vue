<template>
  <table class="l-month-table" @click="handleMonthTableClick" @mousemove="handleMouseMove">
    <tbody>
...
export default defineComponent({
  ...
  setup(props, ctx) {
    ...
    const getCellStyle = (cell) => {
      ...
      style.current =
        castArray(props.parsedValue).findIndex((date) => date.year() === year && date.month() === month) >= 0;
