...
export interface EMessageBoxOptions {
...
export type EMessageBoxShortcutMethod = ((
  message: EMessageBoxOptions['message'],
  title: EMessageBoxOptions['title'],
  options?: EMessageBoxOptions
) => Promise<MessageBoxData>) &
  ((message: EMessageBoxOptions['message'], options?: EMessageBoxOptions) => Promise<MessageBoxData>);
...
export interface IElMessageBox {
  ...
  /** Show a message box */
  (options: EMessageBoxOptions): Promise<MessageBoxData>;

  /** Show an alert message box */
  alert: EMessageBoxShortcutMethod;

  /** Show a confirm message box */
  confirm: EMessageBoxShortcutMethod;

  /** Show a prompt message box */
  prompt: EMessageBoxShortcutMethod;
